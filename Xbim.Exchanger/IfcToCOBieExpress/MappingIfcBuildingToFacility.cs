...
{
    class MappingIfcBuildingToFacility : XbimMappings<IfcStore, IModel, string, IIfcBuilding,CobieFacility> 
    {
        ...
        private IEnumerable<IIfcZone> GetAllZones(IEnumerable<IIfcSpace> allSpaces, COBieExpressHelper helper)
        {
