...
#endif
[assembly:System.Xml.Serialization.XmlSerializerVersionAttribute(ParentAssemblyId=@"b8d574fa-5531-4104-b2ca-c023e225de21,", Version=@"4.0.0.0")]
namespace Microsoft.Xml.Serialization.GeneratedAssembly {
    ...
    public class XmlSerializationWriterFacilityType : System.Xml.Serialization.XmlSerializationWriter {
        ...
        void Write25_IssueType(string n, string ns, global::Xbim.COBieLite.IssueType o, bool isNullable, bool needType) {
            ...
            Write2_ContactKeyType(@"ContactAssignment", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core", ((global::Xbim.COBieLite.ContactKeyType)o.@ContactAssignment), false, false);
        ...
        void Write2_ContactKeyType(string n, string ns, global::Xbim.COBieLite.ContactKeyType o, bool isNullable, bool needType) {
            if ((object)o == null) {
                if (isNullable) WriteNullTagLiteral(n, ns);
                return;
            }
        ...
        void Write83_Item(string n, string ns, global::Xbim.COBieLite.ContactAssignmentCollectionType o, bool isNullable, bool needType) {
            ...
            if (needType) WriteXsiType(@"ContactAssignmentCollectionType", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core");
            {
                ...
                if (a != null) {
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++) {
                        Write2_ContactKeyType(@"ContactAssignment", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core", ((global::Xbim.COBieLite.ContactKeyType)a[ia]), false, false);
                    }
                }
            }
            WriteEndElement(o);
        ...
        void Write43_AssetInfoType(string n, string ns, global::Xbim.COBieLite.AssetInfoType o, bool isNullable, bool needType) {
            ...
            Write15_SpaceAssignmentCollectionType(@"AssetSpaceAssignments", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core", ((global::Xbim.COBieLite.SpaceAssignmentCollectionType)o.@AssetSpaceAssignments), false, false);
        ...
        void Write15_SpaceAssignmentCollectionType(string n, string ns, global::Xbim.COBieLite.SpaceAssignmentCollectionType o, bool isNullable, bool needType) {
            if ((object)o == null) {
                if (isNullable) WriteNullTagLiteral(n, ns);
                return;
            }
            ...
            if (needType) WriteXsiType(@"SpaceAssignmentCollectionType", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core");
            {
                ...
                if (a != null) {
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++) {
                        Write4_SpaceKeyType(@"SpaceAssignment", @"http://docs.buildingsmartalliance.org/nbims03/cobie/core", ((global::Xbim.COBieLite.SpaceKeyType)a[ia]), false, false);
                    }
                }
            }
            WriteEndElement(o);
        ...
        void Write4_SpaceKeyType(string n, string ns, global::Xbim.COBieLite.SpaceKeyType o, bool isNullable, bool needType) {
            if ((object)o == null) {
                if (isNullable) WriteNullTagLiteral(n, ns);
                return;
            }
    ...
    public class XmlSerializationReaderFacilityType : System.Xml.Serialization.XmlSerializationReader {
        ...
        global::Xbim.COBieLite.ContactKeyType Read2_ContactKeyType(bool isNullable, bool checkType) {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            if (checkType) {
        ...
        global::Xbim.COBieLite.AttributeValueType Read78_AttributeValueType(bool isNullable, bool checkType) {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    if (!paramsRead[0] && ((object) Reader.LocalName == (object)id62_AttributeDateTimeValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        {
                    ...
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id63_AttributeBooleanValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        o.@Item = Read40_BooleanValueType(false, true);
                        o.@ItemElementName = global::Xbim.COBieLite.ItemChoiceType.@AttributeBooleanValue;
                        paramsRead[0] = true;
                    }
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id64_AttributeStringValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                    ...
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id66_AttributeTimeValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        {
                    ...
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id67_AttributeDateValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        {
                    ...
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id68_AttributeDecimalValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                    ...
                    else if (!paramsRead[0] && ((object) Reader.LocalName == (object)id69_AttributeIntegerValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        ...
                        UnknownNode((object)o, @"http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDateTimeValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeBooleanValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeStringValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeMonetaryValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeTimeValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDateValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDecimalValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeIntegerValue");
                    }
                }
                else {
                    UnknownNode((object)o, @"http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDateTimeValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeBooleanValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeStringValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeMonetaryValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeTimeValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDateValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeDecimalValue, http://docs.buildingsmartalliance.org/nbims03/cobie/core:AttributeIntegerValue");
        ...
        global::Xbim.COBieLite.AttributeIntegerValueType Read37_AttributeIntegerValueType(bool isNullable, bool checkType) {
            ...
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            if (xsiType == null || ((object) ((System.Xml.XmlQualifiedName)xsiType).Name == (object)id70_AttributeIntegerValueType && (object) ((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id5_Item)) {
            }
            else
                throw CreateUnknownTypeException((System.Xml.XmlQualifiedName)xsiType);
            }
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    ...
                    else if (!paramsRead[1] && ((object) Reader.LocalName == (object)id72_IntegerValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        o.@IntegerValue = Read36_NullableOfInt32(true);
                        paramsRead[1] = true;
                    }
                    else if (!paramsRead[2] && ((object) Reader.LocalName == (object)id73_MinValueInteger && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        o.@MinValueInteger = Read36_NullableOfInt32(true);
                        paramsRead[2] = true;
                    }
                    else if (!paramsRead[3] && ((object) Reader.LocalName == (object)id74_MaxValueInteger && (object) Reader.NamespaceURI == (object)id5_Item)) {
        ...
        global::Xbim.COBieLite.AttributeDecimalValueType Read39_AttributeDecimalValueType(bool isNullable, bool checkType) {
            ...
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            if (xsiType == null || ((object) ((System.Xml.XmlQualifiedName)xsiType).Name == (object)id75_AttributeDecimalValueType && (object) ((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id5_Item)) {
            }
            else
                throw CreateUnknownTypeException((System.Xml.XmlQualifiedName)xsiType);
            }
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    ...
                    else if (!paramsRead[1] && ((object) Reader.LocalName == (object)id76_DecimalValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                    ...
                    else if (!paramsRead[2] && ((object) Reader.LocalName == (object)id77_MinValueDecimal && (object) Reader.NamespaceURI == (object)id5_Item)) {
                    ...
                    else if (!paramsRead[3] && ((object) Reader.LocalName == (object)id78_MaxValueDecimal && (object) Reader.NamespaceURI == (object)id5_Item)) {
        ...
        global::Xbim.COBieLite.AttributeMonetaryValueType Read77_AttributeMonetaryValueType(bool isNullable, bool checkType) {
            ...
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            if (xsiType == null || ((object) ((System.Xml.XmlQualifiedName)xsiType).Name == (object)id79_AttributeMonetaryValueType && (object) ((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id5_Item)) {
            }
            else
                throw CreateUnknownTypeException((System.Xml.XmlQualifiedName)xsiType);
            }
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    if (!paramsRead[0] && ((object) Reader.LocalName == (object)id80_MonetaryValue && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        {
                            o.@MonetaryValue = System.Xml.XmlConvert.ToDecimal(Reader.ReadElementString());
                        }
                        paramsRead[0] = true;
                    }
                    else if (!paramsRead[1] && ((object) Reader.LocalName == (object)id81_MonetaryUnit && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        {
        ...
        global::Xbim.COBieLite.DecimalValueType Read42_DecimalValueType(bool isNullable, bool checkType) {
            ...
            else if (((object) ((System.Xml.XmlQualifiedName)xsiType).Name == (object)id75_AttributeDecimalValueType && (object) ((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id5_Item))
        ...
        global::Xbim.COBieLite.IntegerValueType Read38_IntegerValueType(bool isNullable, bool checkType) {
            ...
            else if (((object) ((System.Xml.XmlQualifiedName)xsiType).Name == (object)id70_AttributeIntegerValueType && (object) ((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id5_Item))
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    if (!paramsRead[3] && ((object) Reader.LocalName == (object)id228_AssetName && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        ...
                        o.@AssetSpaceAssignments = Read15_SpaceAssignmentCollectionType(false, true);
                        paramsRead[4] = true;
                    }
        ...
        global::Xbim.COBieLite.SpaceAssignmentCollectionType Read15_SpaceAssignmentCollectionType(bool isNullable, bool checkType) {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    if (((object) Reader.LocalName == (object)id249_SpaceAssignment && (object) Reader.NamespaceURI == (object)id5_Item)) {
                        if ((object)(a_0) == null) Reader.Skip(); else a_0.Add(Read4_SpaceKeyType(false, true));
                    }
                    else {
        ...
        global::Xbim.COBieLite.SpaceKeyType Read4_SpaceKeyType(bool isNullable, bool checkType) {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            if (checkType) {
        ...
        string id67_AttributeDateValue;
        string id288_ZoneKeyType;
        string id77_MinValueDecimal;
        ...
        string id79_AttributeMonetaryValueType;
        ...
        string id66_AttributeTimeValue;
        ...
        string id75_AttributeDecimalValueType;
        ...
        string id70_AttributeIntegerValueType;
        ...
        string id62_AttributeDateTimeValue;
        ...
        string id68_AttributeDecimalValue;
        string id158_Spares;
        string id69_AttributeIntegerValue;
        ...
        protected override void InitIDs() {
            ...
            id67_AttributeDateValue = Reader.NameTable.Add(@"AttributeDateValue");
            id288_ZoneKeyType = Reader.NameTable.Add(@"ZoneKeyType");
            id77_MinValueDecimal = Reader.NameTable.Add(@"MinValueDecimal");
            ...
            id80_MonetaryValue = Reader.NameTable.Add(@"MonetaryValue");
            ...
            id79_AttributeMonetaryValueType = Reader.NameTable.Add(@"AttributeMonetaryValueType");
            ...
            id66_AttributeTimeValue = Reader.NameTable.Add(@"AttributeTimeValue");
            ...
            id81_MonetaryUnit = Reader.NameTable.Add(@"MonetaryUnit");
            ...
            id76_DecimalValue = Reader.NameTable.Add(@"DecimalValue");
            id211_SpareAttributes = Reader.NameTable.Add(@"SpareAttributes");
            id63_AttributeBooleanValue = Reader.NameTable.Add(@"AttributeBooleanValue");
            ...
            id64_AttributeStringValue = Reader.NameTable.Add(@"AttributeStringValue");
            ...
            id75_AttributeDecimalValueType = Reader.NameTable.Add(@"AttributeDecimalValueType");
            ...
            id70_AttributeIntegerValueType = Reader.NameTable.Add(@"AttributeIntegerValueType");
            ...
            id78_MaxValueDecimal = Reader.NameTable.Add(@"MaxValueDecimal");
            ...
            id62_AttributeDateTimeValue = Reader.NameTable.Add(@"AttributeDateTimeValue");
            ...
            id74_MaxValueInteger = Reader.NameTable.Add(@"MaxValueInteger");
            ...
            id68_AttributeDecimalValue = Reader.NameTable.Add(@"AttributeDecimalValue");
            id158_Spares = Reader.NameTable.Add(@"Spares");
            id69_AttributeIntegerValue = Reader.NameTable.Add(@"AttributeIntegerValue");
            ...
            id73_MinValueInteger = Reader.NameTable.Add(@"MinValueInteger");
            ...
            id72_IntegerValue = Reader.NameTable.Add(@"IntegerValue");
