...
@echo off
"C:\Program Files\ResharperCLT2017.1\dupfinder.exe" --discard-literals=true --caches-home="%temp%\DFCache" --o="DuplicateCodeReport.xml" --discard-cost=100 "Xbim.Exchange.Nuget.sln" --show-text
